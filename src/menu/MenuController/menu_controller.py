...
class MenuController:
    ...
    def __init__(self, server_ip, server_port):
        ...
        self.server_offline_notification = Notification(SCREEN_WIDTH, SCREEN_HEIGHT, "server_offline", "Server is offline.", "menu")
        self.lost_connection_with_server = Notification(SCREEN_WIDTH, SCREEN_HEIGHT, "lost_connection", "Connection with server is lost.", "menu")
        self.server_is_full = Notification(SCREEN_WIDTH, SCREEN_HEIGHT, "server_is_full", "Server is full.", "menu")
        self.server_is_closed = Notification(SCREEN_WIDTH, SCREEN_HEIGHT, "server_is_closed", "Server is closed.", "menu")
        self.champion_is_picked = Notification(SCREEN_WIDTH, SCREEN_HEIGHT, "champion_is_picked", "Champion is picked already.", "champion_select")
        self.map = None
